...
namespace Help\PrestaShop\Markdown\Parser\Inline;
...
class EmojiParser implements InlineParserInterface
{
    ...
    {
        if (isset(self::EMOJIS[stripslashes($inlineContext->getSubMatches()[1])])) {
            $inlineContext->getCursor()->advanceBy($inlineContext->getFullMatchLength());
            $inlineContext->getContainer()->appendChild(new Text(
                $inlineContext->getSubMatches()[0] . self::EMOJIS[stripslashes($inlineContext->getSubMatches()[1])]
            ));
